...
import { Breadcrumb, BreadcrumbItem, Button, Label, Input, Col, FormFeedback, Row } from 'reactstrap';
...
{/*the i flag tells the RegExp object to ignore case of the string to be matched.*/ }
                                ...
                                <Col md={10}>
                                    ...
                                    <Errors className="text-danger" model=".telnum"
                                        ...
                                        messages={{
                                            ...
                                            isNumber: 'Tel. Number must be number'
                                        }} />
                                </Col>
                            </Row>
                            <Row className="form-group">
